...
$(call soong_config_set,alpha_bootanimation,height,$(TARGET_SCREEN_HEIGHT))
$(call soong_config_set,alpha_bootanimation,width,$(TARGET_SCREEN_WIDTH))
$(call soong_config_set,alpha_bootanimation,half_res,$(TARGET_BOOTANIMATION_HALF_RES))

ifneq ($(TARGET_BOOTANIMATION),)
$(call soong_config_set,alpha_bootanimation,prebuilt_file,$(TARGET_BOOTANIMATION))
endif
...
$(call soong_config_set,alpha_charger,density,$(alpha_charger_density))
